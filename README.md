...
If you don't know much about programming, programming in Python or don't want to mess with can edit Python file and easily make changes, you can use the JSON file to specifiy the [Channel ID](#Channel--ID), [YouTube Data V3 API Key](#YouTube--Data--V3--API--Key), [Discord Webhook URL](#Discord--Webhook--URL), [Start and End Time](#Start--and--End--Time), and [Delay Time](#Delay--Time). 
